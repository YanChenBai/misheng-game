<template>
  <div class="pt-6 w-full border-t-2 border-[#B6B9D0]/50">
    ...
    <div v-else class="flex gap-2 items-end w-full">
      ...
      <button
        class="py-3 w-25 bg-white text-center border-4 border-[#F9DD7B] rounded-2xl text-xl text-[#BD8958] shadow-[0px_6px_0px_0px_#F9DD7B] cursor-pointer transition-all active:translate-y-1 active:shadow-none"
        type="button"
